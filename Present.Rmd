...
return(pander(paste("Final/Fiscal YTD report completed on ", Final_Report_Date)))
}
```
...
Run Time: September 30 - TBA


```{r}
start_Date <- as.Date("2019-08-30")
Midterm_Report_Date <- start_Date + 60
```
...
* Instagram - Display, Video, Stories
* Twitter - Tweets
* DoubleClick - Display
* Pinterest - Display
* Snapchat - Video
